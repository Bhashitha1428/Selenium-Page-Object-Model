...
import functions.NewtoursCommonFunctions_MethodChaining;
...
//        Assert.assertTrue(actualText.contains("Dear"), "Registration Attempt failed");
        ...
        //or
        NewtoursCommonFunctions_MethodChaining newtoursCommonFunctionsMethodChaining = new NewtoursCommonFunctions_MethodChaining(driver);
        String actualText = newtoursCommonFunctionsMethodChaining.registerUser("Bhashitha", "Ranchagoda", "0716978579",
                "abc@gmail.com", "bmr", "12345", "12345");
        Assert.assertTrue(actualText.contains("Dear"), "Registration Attempt failed");
